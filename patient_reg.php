...
if ((isset($_POST['first'])) and  (isset($_POST['last'])) and  (isset($_POST['user'])) and  (isset($_POST['email'])) and  (isset($_POST['sex'])) and  (isset($_POST['cpass'])))
{
    ...
    $sql1="insert into p_reg(f_name,l_name,username,email,gender,status) values ('$first','$last','$user','$email','$gender',0)";
    $sql2="insert into login(username,password,user_type,status) values ('$user','$pass',1,0)";
